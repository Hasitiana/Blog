...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.GKASTJM' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GKASTJMService()
    {
        return $this->privates['.service_locator.GKASTJM'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3694e = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera7e4b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties1fb31 = [
        
    ];

    public function getConnection()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getConnection', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getMetadataFactory', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getExpressionBuilder', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'beginTransaction', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getCache', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getCache();
    }

    public function transactional($func)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'transactional', array('func' => $func), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->transactional($func);
    }

    public function commit()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'commit', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->commit();
    }

    public function rollback()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'rollback', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getClassMetadata', array('className' => $className), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'createQuery', array('dql' => $dql), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'createNamedQuery', array('name' => $name), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'createQueryBuilder', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'flush', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'clear', array('entityName' => $entityName), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->clear($entityName);
    }

    public function close()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'close', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->close();
    }

    public function persist($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'persist', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'remove', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'refresh', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'detach', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'merge', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getRepository', array('entityName' => $entityName), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'contains', array('entity' => $entity), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getEventManager', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getConfiguration', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'isOpen', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getUnitOfWork', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getProxyFactory', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'initializeObject', array('obj' => $obj), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'getFilters', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'isFiltersStateClean', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'hasFilters', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return $this->valueHolder3694e->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera7e4b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder3694e) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3694e = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3694e->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__get', ['name' => $name], $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        if (isset(self::$publicProperties1fb31[$name])) {
            return $this->valueHolder3694e->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3694e;
    ...
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;
    ...
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__isset', array('name' => $name), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;
    ...
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__unset', array('name' => $name), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;
    ...
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__clone', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        $this->valueHolder3694e = clone $this->valueHolder3694e;
    }

    public function __sleep()
    {
        $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, '__sleep', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;

        return array('valueHolder3694e');
    }
    ...
    {
        $this->initializera7e4b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera7e4b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera7e4b && ($this->initializera7e4b->__invoke($valueHolder3694e, $this, 'initializeProxy', array(), $this->initializera7e4b) || 1) && $this->valueHolder3694e = $valueHolder3694e;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3694e;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3694e;
    }
}
